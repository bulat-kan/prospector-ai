...
from app.analytics import AnalyticsError, CommissionForecast, MonthlyCommissionAnalytics, calculate_monthly_commission, forecast_next_tier
...
def render_dashboard_page() -> None:
    """Render the monthly analytics and commission dashboard."""
